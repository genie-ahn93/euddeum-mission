    ...
    <details className="score-notice participant-notice">
      <summary>
        <span className="notice-summary-text">
          ...
          <span className="notice-period">인증기간 <b>2026. 9. 17.(목) ~ 10. 19.(월)</b></span>
      ...
      <div className="notice-detail">
        <div className="notice-key-info">
          <div><span>📅 인증기간</span><strong>2026. 9. 17.(목) ~ 10. 19.(월)</strong></div>
      ...
      <main className="landing-guide-page">
        ...
        <section className="landing-summary-card">
          <div className="landing-summary-item">
            <span>📅 인증기간</span>
            <strong>2026. 9. 17.(목) ~ 10. 19.(월)</strong>
          </div>
          <div className="landing-summary-item">
            <span>⭐ 참여점수</span>
...
export default App
  ...
  Eye,
  Images,import { useEffect, useMemo, useState } from 'react'
import {
  ArrowLeft,
  ArrowRight,
  Check,
...
export default App
  ...
  LockKeyhole,
  LogOut,import { useEffect, useMemo, useState } from 'react'
import {
  ArrowLeft,
  ArrowRight,
  Check,
